...
public class MKButton : UIButton
{
    ...
    override public func beginTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
        ...
        mkLayer.animateScaleForCircleLayer(fromScale: 0.45, toScale: 1.0, timingFunction: rippleAniTimingFunction, duration: CFTimeInterval(self.rippleAniDuration))
        ...
        if shadowAniEnabled {
            ...
            mkLayer.animateSuperLayerShadow(fromRadius: 10, toRadius: shadowRadius, fromOpacity: 0, toOpacity: shadowOpacity, timingFunction: shadowAniTimingFunction, duration: duration)
        }
