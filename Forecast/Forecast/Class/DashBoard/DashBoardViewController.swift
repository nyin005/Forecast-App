...
//    var BaseURL = "https://forecast-dev.herokuapp.com/api/report/"
    ...
    func initHC() {
        ...
        self.pieChartView?.initHeaderCount(showCount: false)
    ...
    func initYTDH() {
        ...
        self.pieChartView?.initChartUI(arr: (self.reportViewModel.pieChartListModel?.responseData)!)
        self.pieChartView?.initHeaderCount(showCount: true)
        self.scrollViewSet?.scrollView?.addSubview(self.pieChartView!)
    }
